...
const Myprofile = () => {
    ...
    const updateUserProfileData = async () => {
      try {
          const formData = new FormData();  // Corrected this line
                    ...
                    <p className='font-medium'>Phone:</p>
                    {
                        isEdit ? 
                            <input
                                ...
                                type='text'
                            /> : 
                            <p className='text-bg-blue-400'>{userData.phone}</p>
                    }
                ...
                <div className='mt-10'>
                    {
                        isEdit ? 
                            <button 
                                className='border border-primary px-8 py-2 rounded-full hover:bg-primary hover:text-white text-primary transition-all' 
